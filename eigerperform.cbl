      ...
      * Author: Eliott Bonte
      * Date: 06/11/2022
      * Purpose: Use the PERFORM keyword.
      *The PERFORM keyword jumps to an area of code, allowing using mulitple times the same code.
000100 IDENTIFICATION DIVISION.
000200 PROGRAM-ID. EIGER.
000300
...
005500 PERFORM ADD-NUMBER-AND-DISPLAY.
      ...
      * Set up and display additional line
       MOVE "Here's an additional line"
       TO THE-MESSAGE.
